...
const InfoLeftColumn2 = styled.div`
  display: flex;
  flex-direction: column;
...
const InfoRightColumn2 = styled.div`
  display: flex;
  justify-content: center;
  align-items: center;
  margin: 0px;
...
const InfoListHeading = styled.p`
          ...
          <WalletModalProvider>
            ...
            <Wrapper>
              ...
              <Main>
                ...
                <HeroSection id="loanPage">
                  <HeroBoxCol data-aos="fade-down-left">
                    <LeftColumn>
                      <HeroHeader>Interest Distribution and Loan Repayment Details</HeroHeader>
                      <HeroParagraph>Get a comprehensive understanding of your loan repayment terms, interest accrual, and how fees are distributed.</HeroParagraph>
                      <div>
                    ...
                    <RightColumn>
                      <Image className="heroImage" src="/interest_rate.png" alt="Your Image" width={400} height={400} /> {/* Adjust image path and dimensions */}
                    </RightColumn>
                  </HeroBoxCol>
                  <HIWBoxCol>
                    ...
                    <HIWBox >
                      ...
                      <HIWParagraph>
                        Learn about our interest distribution, which benefits MIURA NFT owners and the protocol, and our flexible loan repayment terms.
                    </HIWParagraph>
                ...
                <InfoSection id="loanterms">
                  <InfoBoxCol>
                    <InfoLeftColumn data-aos="fade-right">
                      ...
                      <InfoParagraph>
                      There is no fixed time period to repay loans. As long as the position is safe, borrowing is for an undefined period. However, the fees owed on the loan will continue to accrue over time (5% of the borrowed amount per month). Loans must be paid back with the same asset that was borrowed. For example, if 1 SOL is borrowed, 1 SOL must be repaid with fees accrued in order to repay the loan.
                      </InfoParagraph>
                    </InfoLeftColumn>
                    <InfoRightColumn data-aos="fade-left">
                      <Image src="/loan2.png" alt="Your Image" width={300} height={300} /> {/* Adjust image path and dimensions */}
                    </InfoRightColumn>
                  </InfoBoxCol>

                  <InfoBoxCol2>

                    <InfoRightColumn2 data-aos="fade-up-right">
                      <Image src="/calendar.png" alt="Your Image" width={300} height={300} /> {/* Adjust image path and dimensions */}
                    </InfoRightColumn2>
                    <InfoLeftColumn2 data-aos="fade-right">
                      <Image src="/wave.png" alt="Your Image" width={45} height={40} /> {/* Adjust image path and dimensions */}
                      <InfoHeader>
                      Monthly Interest Accrual
                      </InfoHeader>
                      <InfoParagraph>
                      The interest is fixed at 5% of the borrowed funds and is calculated on a monthly basis.
                      
                      </InfoParagraph>
                      <InfoList>
                        <InfoListHeading>How the Charged Interest Will Be Divided:</InfoListHeading>
                        <OrderedList>
                            <ListItem>2% of the charged interest will be distributed to MIURA NFT owners.</ListItem>
                            <ListItem>2% of the charged interest will go to the treasury to preserve the smooth operation of the protocol.</ListItem>
                            <ListItem>1% of the charged interest will go towards buying and burning MIURA tokens, which will reduce the amount of tokens in circulation and increase the value of the tokens.</ListItem>
                        </OrderedList>
                      </InfoList>
                    </InfoLeftColumn2>
                  </InfoBoxCol2>
